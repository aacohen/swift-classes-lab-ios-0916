...
class Thermometer {
    ...
    var description: String{
        get{
            return "The current temperature is \(self.fahrenheit)°F (\(celsius)°C)"
        }
    }
...
var thermometer = Thermometer(temperature: 88.0)
 ...
 */
thermometer = Thermometer(temperature: 100.0)
